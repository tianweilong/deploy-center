...
auto_reject=(
  ...
  'environments/dev/vibe-kanban-remote/README.md:This directory stores deployment state'
  'environments/dev/vibe-kanban-relay/README.md:This directory stores deployment state'
  'environments/prod/vibe-kanban-remote/README.md:This directory stores deployment state'
  'environments/prod/vibe-kanban-relay/README.md:This directory stores deployment state'
  'environments/dev/vibe-kanban-remote/.env.example:Copy to a local deployment env file on the target host if required\.'
  'environments/dev/vibe-kanban-relay/.env.example:Copy to a local deployment env file on the target host if required\.'
  'environments/prod/vibe-kanban-remote/.env.example:Copy to a local deployment env file on the target host if required\.'
  'environments/prod/vibe-kanban-relay/.env.example:Copy to a local deployment env file on the target host if required\.'
